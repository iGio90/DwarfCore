...
<head>
	...
	<title>Protocol | DwarfCore</title>
...
<nav class="tsd-navigation secondary">
	<ul>
		<li class="current tsd-kind-class tsd-parent-kind-namespace tsd-is-external">
			<a href="node_modules__types_frida_gum.objc.protocol.html" class="tsd-kind-icon">Protocol</a>
			<ul>
				<li class=" tsd-kind-constructor tsd-parent-kind-class tsd-is-external">
					<a href="node_modules__types_frida_gum.objc.protocol.html#constructor" class="tsd-kind-icon">constructor</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-class tsd-is-external">
					<a href="node_modules__types_frida_gum.objc.protocol.html#handle" class="tsd-kind-icon">handle</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-class tsd-is-external">
					<a href="node_modules__types_frida_gum.objc.protocol.html#methods" class="tsd-kind-icon">methods</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-class tsd-is-external">
					<a href="node_modules__types_frida_gum.objc.protocol.html#name" class="tsd-kind-icon">name</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-class tsd-is-external">
					<a href="node_modules__types_frida_gum.objc.protocol.html#properties" class="tsd-kind-icon">properties</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-class tsd-is-external">
					<a href="node_modules__types_frida_gum.objc.protocol.html#protocols" class="tsd-kind-icon">protocols</a>
				</li>
			</ul>
		</li>
	</ul>
	...
	<div class="content-wrap">
		<section class="tsd-panel tsd-comment">
			<div class="tsd-comment tsd-typography">
				<div class="lead">
					<p>Dynamically generated language binding for any Objective-C protocol.</p>
				</div>
			</div>
		</section>
				...
				<div class="tsd-index-content">
					<section class="tsd-index-section tsd-is-external">
						...
						<ul class="tsd-index-list">
							<li class="tsd-kind-constructor tsd-parent-kind-class tsd-is-external"><a href="node_modules__types_frida_gum.objc.protocol.html#constructor" class="tsd-kind-icon">constructor</a></li>
						</ul>
					</section>
					<section class="tsd-index-section tsd-is-external">
						<h3>Properties</h3>
						<ul class="tsd-index-list">
							<li class="tsd-kind-property tsd-parent-kind-class tsd-is-external"><a href="node_modules__types_frida_gum.objc.protocol.html#handle" class="tsd-kind-icon">handle</a></li>
							<li class="tsd-kind-property tsd-parent-kind-class tsd-is-external"><a href="node_modules__types_frida_gum.objc.protocol.html#methods" class="tsd-kind-icon">methods</a></li>
							<li class="tsd-kind-property tsd-parent-kind-class tsd-is-external"><a href="node_modules__types_frida_gum.objc.protocol.html#name" class="tsd-kind-icon">name</a></li>
							<li class="tsd-kind-property tsd-parent-kind-class tsd-is-external"><a href="node_modules__types_frida_gum.objc.protocol.html#properties" class="tsd-kind-icon">properties</a></li>
							<li class="tsd-kind-property tsd-parent-kind-class tsd-is-external"><a href="node_modules__types_frida_gum.objc.protocol.html#protocols" class="tsd-kind-icon">protocols</a></li>
						</ul>
					</section>
				</div>
			</section>
		...
		<section class="tsd-panel-group tsd-member-group tsd-is-external">
			...
			<section class="tsd-panel tsd-member tsd-kind-constructor tsd-parent-kind-class tsd-is-external">
				...
				<ul class="tsd-signatures tsd-kind-constructor tsd-parent-kind-class tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">new <wbr>Protocol<span class="tsd-signature-symbol">(</span>handle<span class="tsd-signature-symbol">: </span><a href="node_modules__types_frida_gum.nativepointer.html" class="tsd-signature-type" data-tsd-kind="Class">NativePointer</a><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><a href="node_modules__types_frida_gum.objc.protocol.html" class="tsd-signature-type" data-tsd-kind="Class">Protocol</a></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						...
						<h4 class="tsd-returns-title">Returns <a href="node_modules__types_frida_gum.objc.protocol.html" class="tsd-signature-type" data-tsd-kind="Class">Protocol</a></h4>
					</li>
				</ul>
			</section>
		</section>
		<section class="tsd-panel-group tsd-member-group tsd-is-external">
			...
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-class tsd-is-external">
				...
				<h3>methods</h3>
				<div class="tsd-signature tsd-kind-icon">methods<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-symbol">{}</span></div>
				<aside class="tsd-sources">
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>Methods declared by this protocol.</p>
					</div>
				</div>
				<div class="tsd-type-declaration">
					...
					<ul class="tsd-parameters">
						<li class="tsd-parameter-index-signature">
							<h5><span class="tsd-signature-symbol">[</span>name: <span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">]: </span><a href="../interfaces/node_modules__types_frida_gum.objc.protocolmethoddescription.html" class="tsd-signature-type" data-tsd-kind="Interface">ProtocolMethodDescription</a></h5>
						</li>
					</ul>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-class tsd-is-external">
				...
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>Name visible to the Objective-C runtime.</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-class tsd-is-external">
				...
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>Properties declared by this protocol.</p>
					</div>
				</div>
				<div class="tsd-type-declaration">
					<h4>Type declaration</h4>
					<ul class="tsd-parameters">
						<li class="tsd-parameter-index-signature">
							<h5><span class="tsd-signature-symbol">[</span>name: <span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">]: </span><a href="../interfaces/node_modules__types_frida_gum.objc.protocolpropertyattributes.html" class="tsd-signature-type" data-tsd-kind="Interface">ProtocolPropertyAttributes</a></h5>
						</li>
					</ul>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-class tsd-is-external">
				...
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>Protocols that this protocol conforms to.</p>
					</div>
				</div>
				<div class="tsd-type-declaration">
					<h4>Type declaration</h4>
