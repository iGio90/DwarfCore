...
<head>
	...
	<title>SocketConnection | DwarfCore</title>
...
<nav class="tsd-navigation secondary">
	<ul>
		<li class="current tsd-kind-class tsd-parent-kind-module tsd-is-external">
			<a href="node_modules__types_frida_gum.socketconnection.html" class="tsd-kind-icon">Socket<wbr>Connection</a>
			<ul>
				<li class=" tsd-kind-constructor tsd-parent-kind-class tsd-is-inherited tsd-is-external">
					<a href="node_modules__types_frida_gum.socketconnection.html#constructor" class="tsd-kind-icon">constructor</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-class tsd-is-inherited tsd-is-external">
					<a href="node_modules__types_frida_gum.socketconnection.html#input" class="tsd-kind-icon">input</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-class tsd-is-inherited tsd-is-external">
					<a href="node_modules__types_frida_gum.socketconnection.html#output" class="tsd-kind-icon">output</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-class tsd-is-inherited tsd-is-external">
					<a href="node_modules__types_frida_gum.socketconnection.html#close" class="tsd-kind-icon">close</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-class tsd-is-external">
					<a href="node_modules__types_frida_gum.socketconnection.html#setnodelay" class="tsd-kind-icon">set<wbr>NoDelay</a>
				</li>
			</ul>
		</li>
	</ul>
	...
	<div class="content-wrap">
		<section class="tsd-panel tsd-hierarchy">
			...
			<ul class="tsd-hierarchy">
				<li>
					<a href="node_modules__types_frida_gum.iostream.html" class="tsd-signature-type" data-tsd-kind="Class">IOStream</a>
					<ul class="tsd-hierarchy">
						<li>
							<span class="target">SocketConnection</span>
						</li>
					</ul>
				</li>
			</ul>
				...
				<div class="tsd-index-content">
					<section class="tsd-index-section tsd-is-external">
						...
						<ul class="tsd-index-list">
							<li class="tsd-kind-constructor tsd-parent-kind-class tsd-is-inherited tsd-is-external"><a href="node_modules__types_frida_gum.socketconnection.html#constructor" class="tsd-kind-icon">constructor</a></li>
						</ul>
					</section>
					<section class="tsd-index-section tsd-is-external">
						<h3>Properties</h3>
						<ul class="tsd-index-list">
							<li class="tsd-kind-property tsd-parent-kind-class tsd-is-inherited tsd-is-external"><a href="node_modules__types_frida_gum.socketconnection.html#input" class="tsd-kind-icon">input</a></li>
							<li class="tsd-kind-property tsd-parent-kind-class tsd-is-inherited tsd-is-external"><a href="node_modules__types_frida_gum.socketconnection.html#output" class="tsd-kind-icon">output</a></li>
						</ul>
					</section>
					<section class="tsd-index-section tsd-is-external">
						<h3>Methods</h3>
						<ul class="tsd-index-list">
							<li class="tsd-kind-method tsd-parent-kind-class tsd-is-inherited tsd-is-external"><a href="node_modules__types_frida_gum.socketconnection.html#close" class="tsd-kind-icon">close</a></li>
							<li class="tsd-kind-method tsd-parent-kind-class tsd-is-external"><a href="node_modules__types_frida_gum.socketconnection.html#setnodelay" class="tsd-kind-icon">set<wbr>NoDelay</a></li>
						</ul>
					</section>
				</div>
			</section>
		...
		<section class="tsd-panel-group tsd-member-group tsd-is-external">
			...
			<section class="tsd-panel tsd-member tsd-kind-constructor tsd-parent-kind-class tsd-is-inherited tsd-is-external">
				...
				<ul class="tsd-signatures tsd-kind-constructor tsd-parent-kind-class tsd-is-inherited tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">new <wbr>Socket<wbr>Connection<span class="tsd-signature-symbol">(</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><a href="node_modules__types_frida_gum.socketconnection.html" class="tsd-signature-type" data-tsd-kind="Class">SocketConnection</a></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<p>Inherited from <a href="node_modules__types_frida_gum.iostream.html">IOStream</a>.<a href="node_modules__types_frida_gum.iostream.html#constructor">constructor</a></p>
						</aside>
						<h4 class="tsd-returns-title">Returns <a href="node_modules__types_frida_gum.socketconnection.html" class="tsd-signature-type" data-tsd-kind="Class">SocketConnection</a></h4>
					</li>
				</ul>
			</section>
		</section>
		<section class="tsd-panel-group tsd-member-group tsd-is-external">
			...
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-class tsd-is-inherited tsd-is-external">
				...
				<h3>input</h3>
				<div class="tsd-signature tsd-kind-icon">input<span class="tsd-signature-symbol">:</span> <a href="node_modules__types_frida_gum.inputstream.html" class="tsd-signature-type" data-tsd-kind="Class">InputStream</a></div>
				<aside class="tsd-sources">
					<p>Inherited from <a href="node_modules__types_frida_gum.iostream.html">IOStream</a>.<a href="node_modules__types_frida_gum.iostream.html#input">input</a></p>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>The <code>InputStream</code> to read from.</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-class tsd-is-inherited tsd-is-external">
				...
				<h3>output</h3>
				<div class="tsd-signature tsd-kind-icon">output<span class="tsd-signature-symbol">:</span> <a href="node_modules__types_frida_gum.outputstream.html" class="tsd-signature-type" data-tsd-kind="Class">OutputStream</a></div>
				<aside class="tsd-sources">
					<p>Inherited from <a href="node_modules__types_frida_gum.iostream.html">IOStream</a>.<a href="node_modules__types_frida_gum.iostream.html#output">output</a></p>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>The <code>OutputStream</code> to write to.</p>
					</div>
				</div>
			</section>
		</section>
		<section class="tsd-panel-group tsd-member-group tsd-is-external">
			...
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class tsd-is-inherited tsd-is-external">
				...
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<p>Inherited from <a href="node_modules__types_frida_gum.iostream.html">IOStream</a>.<a href="node_modules__types_frida_gum.iostream.html#close">close</a></p>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Closes the stream, releasing resources related to it. This will also close the individual input and output
			...
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class tsd-is-external">
				...
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">set<wbr>NoDelay<span class="tsd-signature-symbol">(</span>noDelay<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">boolean</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">void</span><span class="tsd-signature-symbol">&gt;</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
						...
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Disables the Nagle algorithm if <code>noDelay</code> is <code>true</code>, otherwise enables it. The Nagle algorithm is enabled
						...
						<ul class="tsd-parameters">
							<li>
								<h5>noDelay: <span class="tsd-signature-type">boolean</span></h5>
							</li>
						</ul>
						<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">void</span><span class="tsd-signature-symbol">&gt;</span></h4>
					</li>
