...
<nav class="tsd-navigation secondary">
	<ul>
		<li class="current tsd-kind-class tsd-parent-kind-namespace tsd-is-external">
			<a href="node_modules__types_frida_gum.objc.block.html" class="tsd-kind-icon">Block</a>
			<ul>
				<li class=" tsd-kind-constructor tsd-parent-kind-class tsd-is-external">
					<a href="node_modules__types_frida_gum.objc.block.html#constructor" class="tsd-kind-icon">constructor</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-class tsd-is-external">
					<a href="node_modules__types_frida_gum.objc.block.html#handle" class="tsd-kind-icon">handle</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-class tsd-is-external">
					<a href="node_modules__types_frida_gum.objc.block.html#implementation" class="tsd-kind-icon">implementation</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-class tsd-is-external">
					<a href="node_modules__types_frida_gum.objc.block.html#types" class="tsd-kind-icon">types</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-class tsd-is-external">
					<a href="node_modules__types_frida_gum.objc.block.html#declare" class="tsd-kind-icon">declare</a>
				</li>
			</ul>
		</li>
	</ul>
	...
	<div class="content-wrap">
		<section class="tsd-panel tsd-comment">
			<div class="tsd-comment tsd-typography">
				<div class="lead">
					<p>Dynamically generated language binding for any Objective-C block.</p>
				</div>
				...
				<div class="tsd-index-content">
					<section class="tsd-index-section tsd-is-external">
						...
						<ul class="tsd-index-list">
							<li class="tsd-kind-constructor tsd-parent-kind-class tsd-is-external"><a href="node_modules__types_frida_gum.objc.block.html#constructor" class="tsd-kind-icon">constructor</a></li>
						</ul>
					</section>
					<section class="tsd-index-section tsd-is-external">
						<h3>Properties</h3>
						<ul class="tsd-index-list">
							<li class="tsd-kind-property tsd-parent-kind-class tsd-is-external"><a href="node_modules__types_frida_gum.objc.block.html#handle" class="tsd-kind-icon">handle</a></li>
							<li class="tsd-kind-property tsd-parent-kind-class tsd-is-external"><a href="node_modules__types_frida_gum.objc.block.html#implementation" class="tsd-kind-icon">implementation</a></li>
							<li class="tsd-kind-property tsd-parent-kind-class tsd-is-external"><a href="node_modules__types_frida_gum.objc.block.html#types" class="tsd-kind-icon">types</a></li>
						</ul>
					</section>
					<section class="tsd-index-section tsd-is-external">
						<h3>Methods</h3>
						<ul class="tsd-index-list">
							<li class="tsd-kind-method tsd-parent-kind-class tsd-is-external"><a href="node_modules__types_frida_gum.objc.block.html#declare" class="tsd-kind-icon">declare</a></li>
						</ul>
					</section>
				</div>
			</section>
		...
		<section class="tsd-panel-group tsd-member-group tsd-is-external">
			...
			<section class="tsd-panel tsd-member tsd-kind-constructor tsd-parent-kind-class tsd-is-external">
				...
				<ul class="tsd-signatures tsd-kind-constructor tsd-parent-kind-class tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">new <wbr>Block<span class="tsd-signature-symbol">(</span>target<span class="tsd-signature-symbol">: </span><a href="node_modules__types_frida_gum.nativepointer.html" class="tsd-signature-type" data-tsd-kind="Class">NativePointer</a><span class="tsd-signature-symbol"> | </span><a href="../interfaces/node_modules__types_frida_gum.objc.simplemethodspec.html" class="tsd-signature-type" data-tsd-kind="Interface">SimpleMethodSpec</a><span class="tsd-signature-symbol">&lt;</span><a href="../modules/node_modules__types_frida_gum.objc.html#blockimplementation" class="tsd-signature-type" data-tsd-kind="Type alias">BlockImplementation</a><span class="tsd-signature-symbol">&gt;</span><span class="tsd-signature-symbol"> | </span><a href="../interfaces/node_modules__types_frida_gum.objc.detailedmethodspec.html" class="tsd-signature-type" data-tsd-kind="Interface">DetailedMethodSpec</a><span class="tsd-signature-symbol">&lt;</span><a href="../modules/node_modules__types_frida_gum.objc.html#blockimplementation" class="tsd-signature-type" data-tsd-kind="Type alias">BlockImplementation</a><span class="tsd-signature-symbol">&gt;</span>, options<span class="tsd-signature-symbol">?: </span><a href="../interfaces/node_modules__types_frida_gum.nativefunctionoptions.html" class="tsd-signature-type" data-tsd-kind="Interface">NativeFunctionOptions</a><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><a href="node_modules__types_frida_gum.objc.block.html" class="tsd-signature-type" data-tsd-kind="Class">Block</a></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						...
						<ul class="tsd-parameters">
							<li>
								<h5>target: <a href="node_modules__types_frida_gum.nativepointer.html" class="tsd-signature-type" data-tsd-kind="Class">NativePointer</a><span class="tsd-signature-symbol"> | </span><a href="../interfaces/node_modules__types_frida_gum.objc.simplemethodspec.html" class="tsd-signature-type" data-tsd-kind="Interface">SimpleMethodSpec</a><span class="tsd-signature-symbol">&lt;</span><a href="../modules/node_modules__types_frida_gum.objc.html#blockimplementation" class="tsd-signature-type" data-tsd-kind="Type alias">BlockImplementation</a><span class="tsd-signature-symbol">&gt;</span><span class="tsd-signature-symbol"> | </span><a href="../interfaces/node_modules__types_frida_gum.objc.detailedmethodspec.html" class="tsd-signature-type" data-tsd-kind="Interface">DetailedMethodSpec</a><span class="tsd-signature-symbol">&lt;</span><a href="../modules/node_modules__types_frida_gum.objc.html#blockimplementation" class="tsd-signature-type" data-tsd-kind="Type alias">BlockImplementation</a><span class="tsd-signature-symbol">&gt;</span></h5>
							</li>
							<li>
								<h5><span class="tsd-flag ts-flagOptional">Optional</span> options: <a href="../interfaces/node_modules__types_frida_gum.nativefunctionoptions.html" class="tsd-signature-type" data-tsd-kind="Interface">NativeFunctionOptions</a></h5>
							</li>
						</ul>
						<h4 class="tsd-returns-title">Returns <a href="node_modules__types_frida_gum.objc.block.html" class="tsd-signature-type" data-tsd-kind="Class">Block</a></h4>
					</li>
				</ul>
			</section>
		</section>
		<section class="tsd-panel-group tsd-member-group tsd-is-external">
			...
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-class tsd-is-external">
				...
				<div class="tsd-signature tsd-kind-icon">implementation<span class="tsd-signature-symbol">:</span> <a href="../modules/node_modules__types_frida_gum.html#anyfunction" class="tsd-signature-type" data-tsd-kind="Type alias">AnyFunction</a></div>
				<aside class="tsd-sources">
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>Current implementation. You may replace it by assigning to this property.</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-class tsd-is-external">
		...
		<section class="tsd-panel-group tsd-member-group tsd-is-external">
			...
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class tsd-is-external">
				...
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">declare<span class="tsd-signature-symbol">(</span>signature<span class="tsd-signature-symbol">: </span><a href="../modules/node_modules__types_frida_gum.objc.html#blocksignature" class="tsd-signature-type" data-tsd-kind="Type alias">BlockSignature</a><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">void</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
						...
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Declares the signature of an externally defined block. This is needed
						...
						<ul class="tsd-parameters">
							<li>
								<h5>signature: <a href="../modules/node_modules__types_frida_gum.objc.html#blocksignature" class="tsd-signature-type" data-tsd-kind="Type alias">BlockSignature</a></h5>
								<div class="tsd-comment tsd-typography">
									<p>Signature to use.</p>
								</div>
							</li>
						</ul>
