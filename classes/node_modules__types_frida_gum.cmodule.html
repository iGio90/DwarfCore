...
<nav class="tsd-navigation secondary">
	<ul>
		<li class="current tsd-kind-class tsd-parent-kind-module tsd-is-external">
			<a href="node_modules__types_frida_gum.cmodule.html" class="tsd-kind-icon">CModule</a>
			<ul>
				<li class=" tsd-kind-constructor tsd-parent-kind-class tsd-is-external">
					<a href="node_modules__types_frida_gum.cmodule.html#constructor" class="tsd-kind-icon">constructor</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-class tsd-is-static tsd-is-external">
					<a href="node_modules__types_frida_gum.cmodule.html#builtins" class="tsd-kind-icon">builtins</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-class tsd-is-external">
					<a href="node_modules__types_frida_gum.cmodule.html#dispose" class="tsd-kind-icon">dispose</a>
				</li>
			</ul>
		</li>
	</ul>
	...
	<div class="content-wrap">
		<section class="tsd-panel tsd-comment">
			<div class="tsd-comment tsd-typography">
				<div class="lead">
					<p>Compiles C source code to machine code, straight to memory. May also be
				...
				<pre><code><span style="color: #9ECBFF">`void init (void)`</span>
<span style="color: #9ECBFF">`void finalize (void)`</span>
</code></pre>
		...
		<section class="tsd-panel tsd-hierarchy">
			...
			<ul class="tsd-hierarchy">
				<li>
					<span class="target">CModule</span>
				</li>
			</ul>
		</section>
...
<span style="color: #9ECBFF">`void finalize (void)`</span>
				...
				<div class="tsd-index-content">
					<section class="tsd-index-section tsd-is-external">
						...
						<ul class="tsd-index-list">
							<li class="tsd-kind-constructor tsd-parent-kind-class tsd-is-external"><a href="node_modules__types_frida_gum.cmodule.html#constructor" class="tsd-kind-icon">constructor</a></li>
						</ul>
					</section>
					<section class="tsd-index-section tsd-is-external">
						<h3>Properties</h3>
						<ul class="tsd-index-list">
							<li class="tsd-kind-property tsd-parent-kind-class tsd-is-static tsd-is-external"><a href="node_modules__types_frida_gum.cmodule.html#builtins" class="tsd-kind-icon">builtins</a></li>
						</ul>
					</section>
					<section class="tsd-index-section tsd-is-external">
						<h3>Methods</h3>
						<ul class="tsd-index-list">
							<li class="tsd-kind-method tsd-parent-kind-class tsd-is-external"><a href="node_modules__types_frida_gum.cmodule.html#dispose" class="tsd-kind-icon">dispose</a></li>
						</ul>
					</section>
				</div>
			</section>
		...
		<section class="tsd-panel-group tsd-member-group tsd-is-external">
			...
			<section class="tsd-panel tsd-member tsd-kind-constructor tsd-parent-kind-class tsd-is-external">
				...
				<ul class="tsd-signatures tsd-kind-constructor tsd-parent-kind-class tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">new CModule<span class="tsd-signature-symbol">(</span>code<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol"> | </span><a href="../modules/node_modules__types_frida_gum.html#arraybuffer-1" class="tsd-signature-type" data-tsd-kind="Variable">ArrayBuffer</a>, symbols<span class="tsd-signature-symbol">?: </span><a href="../interfaces/node_modules__types_frida_gum.csymbols.html" class="tsd-signature-type" data-tsd-kind="Interface">CSymbols</a>, options<span class="tsd-signature-symbol">?: </span><a href="../interfaces/node_modules__types_frida_gum.cmoduleoptions.html" class="tsd-signature-type" data-tsd-kind="Interface">CModuleOptions</a><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><a href="node_modules__types_frida_gum.cmodule.html" class="tsd-signature-type" data-tsd-kind="Class">CModule</a></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						...
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Creates a new C module from the provided <code>code</code>.</p>
							</div>
						</div>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
							<li>
								<h5>code: <span class="tsd-signature-type">string</span><span class="tsd-signature-symbol"> | </span><a href="../modules/node_modules__types_frida_gum.html#arraybuffer-1" class="tsd-signature-type" data-tsd-kind="Variable">ArrayBuffer</a></h5>
								<div class="tsd-comment tsd-typography">
									<p>C source code to compile, or a precompiled shared library.</p>
								</div>
							</li>
							<li>
								<h5><span class="tsd-flag ts-flagOptional">Optional</span> symbols: <a href="../interfaces/node_modules__types_frida_gum.csymbols.html" class="tsd-signature-type" data-tsd-kind="Interface">CSymbols</a></h5>
								<div class="tsd-comment tsd-typography">
									<p>Symbols to expose to the C module. Declare them as <code>extern</code>.
							...
							<li>
								<h5><span class="tsd-flag ts-flagOptional">Optional</span> options: <a href="../interfaces/node_modules__types_frida_gum.cmoduleoptions.html" class="tsd-signature-type" data-tsd-kind="Interface">CModuleOptions</a></h5>
								<div class="tsd-comment tsd-typography">
									<p>Options for customizing the construction.</p>
								</div>
							</li>
						</ul>
						<h4 class="tsd-returns-title">Returns <a href="node_modules__types_frida_gum.cmodule.html" class="tsd-signature-type" data-tsd-kind="Class">CModule</a></h4>
					</li>
				</ul>
			</section>
		</section>
		<section class="tsd-panel-group tsd-member-group tsd-is-external">
			...
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-class tsd-is-static tsd-is-external">
				...
				<h3><span class="tsd-flag ts-flagStatic">Static</span> builtins</h3>
				<div class="tsd-signature tsd-kind-icon">builtins<span class="tsd-signature-symbol">:</span> <a href="../interfaces/node_modules__types_frida_gum.cmodulebuiltins.html" class="tsd-signature-type" data-tsd-kind="Interface">CModuleBuiltins</a></div>
				<aside class="tsd-sources">
				</aside>
			</section>
		</section>
			...
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class tsd-is-external">
				...
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						...
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Eagerly unmaps the module from memory. Useful for short-lived modules
