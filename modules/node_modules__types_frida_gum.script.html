...
<nav class="tsd-navigation secondary">
	<ul>
		<li class=" tsd-kind-variable tsd-parent-kind-namespace tsd-is-external">
			<a href="node_modules__types_frida_gum.script.html#filename" class="tsd-kind-icon">file<wbr>Name</a>
		</li>
		<li class=" tsd-kind-variable tsd-parent-kind-namespace tsd-is-external">
			<a href="node_modules__types_frida_gum.script.html#runtime" class="tsd-kind-icon">runtime</a>
		</li>
		<li class=" tsd-kind-variable tsd-parent-kind-namespace tsd-is-external">
			<a href="node_modules__types_frida_gum.script.html#sourcemap" class="tsd-kind-icon">source<wbr>Map</a>
		</li>
		<li class=" tsd-kind-function tsd-parent-kind-namespace tsd-is-external">
			<a href="node_modules__types_frida_gum.script.html#nexttick" class="tsd-kind-icon">next<wbr>Tick</a>
		</li>
		<li class=" tsd-kind-function tsd-parent-kind-namespace tsd-is-external">
			<a href="node_modules__types_frida_gum.script.html#pin" class="tsd-kind-icon">pin</a>
		</li>
		<li class=" tsd-kind-function tsd-parent-kind-namespace tsd-is-external">
			<a href="node_modules__types_frida_gum.script.html#setglobalaccesshandler" class="tsd-kind-icon">set<wbr>Global<wbr>Access<wbr>Handler</a>
		</li>
		<li class=" tsd-kind-function tsd-parent-kind-namespace tsd-is-external">
			<a href="node_modules__types_frida_gum.script.html#unpin" class="tsd-kind-icon">unpin</a>
		</li>
	</ul>
</nav>
	...
	<div class="content-wrap">
				...
				<div class="tsd-index-content">
					<section class="tsd-index-section tsd-is-external">
						...
						<ul class="tsd-index-list">
							<li class="tsd-kind-variable tsd-parent-kind-namespace tsd-is-external"><a href="node_modules__types_frida_gum.script.html#filename" class="tsd-kind-icon">file<wbr>Name</a></li>
							<li class="tsd-kind-variable tsd-parent-kind-namespace tsd-is-external"><a href="node_modules__types_frida_gum.script.html#runtime" class="tsd-kind-icon">runtime</a></li>
							<li class="tsd-kind-variable tsd-parent-kind-namespace tsd-is-external"><a href="node_modules__types_frida_gum.script.html#sourcemap" class="tsd-kind-icon">source<wbr>Map</a></li>
						</ul>
					</section>
					<section class="tsd-index-section tsd-is-external">
						<h3>Functions</h3>
						<ul class="tsd-index-list">
							<li class="tsd-kind-function tsd-parent-kind-namespace tsd-is-external"><a href="node_modules__types_frida_gum.script.html#nexttick" class="tsd-kind-icon">next<wbr>Tick</a></li>
							<li class="tsd-kind-function tsd-parent-kind-namespace tsd-is-external"><a href="node_modules__types_frida_gum.script.html#pin" class="tsd-kind-icon">pin</a></li>
							<li class="tsd-kind-function tsd-parent-kind-namespace tsd-is-external"><a href="node_modules__types_frida_gum.script.html#setglobalaccesshandler" class="tsd-kind-icon">set<wbr>Global<wbr>Access<wbr>Handler</a></li>
							<li class="tsd-kind-function tsd-parent-kind-namespace tsd-is-external"><a href="node_modules__types_frida_gum.script.html#unpin" class="tsd-kind-icon">unpin</a></li>
						</ul>
					</section>
				</div>
			</section>
		...
		<section class="tsd-panel-group tsd-member-group tsd-is-external">
			...
			<section class="tsd-panel tsd-member tsd-kind-variable tsd-parent-kind-namespace tsd-is-external">
				...
				<h3><span class="tsd-flag ts-flagConst">Const</span> file<wbr>Name</h3>
				...
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>File name of the current script.</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-variable tsd-parent-kind-namespace tsd-is-external">
				...
				<div class="tsd-signature tsd-kind-icon">runtime<span class="tsd-signature-symbol">:</span> <a href="node_modules__types_frida_gum.html#scriptruntime" class="tsd-signature-type" data-tsd-kind="Type alias">ScriptRuntime</a></div>
				<aside class="tsd-sources">
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>Runtime being used.</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-variable tsd-parent-kind-namespace tsd-is-external">
				<a name="sourcemap" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagConst">Const</span> source<wbr>Map</h3>
				<div class="tsd-signature tsd-kind-icon">source<wbr>Map<span class="tsd-signature-symbol">:</span> <a href="../classes/node_modules__types_frida_gum.sourcemap.html" class="tsd-signature-type" data-tsd-kind="Class">SourceMap</a></div>
				<aside class="tsd-sources">
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>Source map of the current script.</p>
					</div>
				</div>
			</section>
		</section>
		<section class="tsd-panel-group tsd-member-group tsd-is-external">
			...
			<section class="tsd-panel tsd-member tsd-kind-function tsd-parent-kind-namespace tsd-is-external">
				...
				<ul class="tsd-signatures tsd-kind-function tsd-parent-kind-namespace tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">next<wbr>Tick<span class="tsd-signature-symbol">(</span>func<span class="tsd-signature-symbol">: </span><a href="node_modules__types_frida_gum.html#scheduledcallback" class="tsd-signature-type" data-tsd-kind="Type alias">ScheduledCallback</a>, <span class="tsd-signature-symbol">...</span>params<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">any</span><span class="tsd-signature-symbol">[]</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">void</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						...
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Runs <code>func</code> on the next tick, i.e. when the current native thread exits
			...
			<section class="tsd-panel tsd-member tsd-kind-function tsd-parent-kind-namespace tsd-is-external">
				...
				<h3>pin</h3>
				<ul class="tsd-signatures tsd-kind-function tsd-parent-kind-namespace tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">pin<span class="tsd-signature-symbol">(</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">void</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
						...
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Temporarily prevents the current script from being unloaded.
									This is reference-counted, so there must be one matching <code>unpin()</code>
								happening at a later point.</p>
							</div>
							<p>Typically used in the callback of <code>WeakRef.bind()</code> when you need to
			...
			<section class="tsd-panel tsd-member tsd-kind-function tsd-parent-kind-namespace tsd-is-external">
				<a name="setglobalaccesshandler" class="tsd-anchor"></a>
				<h3>set<wbr>Global<wbr>Access<wbr>Handler</h3>
				<ul class="tsd-signatures tsd-kind-function tsd-parent-kind-namespace tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">set<wbr>Global<wbr>Access<wbr>Handler<span class="tsd-signature-symbol">(</span>handler<span class="tsd-signature-symbol">: </span><a href="../interfaces/node_modules__types_frida_gum.globalaccesshandler.html" class="tsd-signature-type" data-tsd-kind="Interface">GlobalAccessHandler</a><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">null</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">void</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
						...
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Installs or uninstalls a handler that is used to resolve attempts to
						...
						<ul class="tsd-parameters">
							<li>
								<h5>handler: <a href="../interfaces/node_modules__types_frida_gum.globalaccesshandler.html" class="tsd-signature-type" data-tsd-kind="Interface">GlobalAccessHandler</a><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">null</span></h5>
								<div class="tsd-comment tsd-typography">
									<p>The handler to install, or <code>null</code> to uninstall a
			...
			<section class="tsd-panel tsd-member tsd-kind-function tsd-parent-kind-namespace tsd-is-external">
				...
				<h3>unpin</h3>
				<ul class="tsd-signatures tsd-kind-function tsd-parent-kind-namespace tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">unpin<span class="tsd-signature-symbol">(</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">void</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
						...
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Reverses a previous <code>pin()</code> so the current script may be unloaded.</p>
							</div>
						</div>
						<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">void</span></h4>
					</li>
