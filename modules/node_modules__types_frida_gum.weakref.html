...
<nav class="tsd-navigation secondary">
	<ul>
		<li class=" tsd-kind-function tsd-parent-kind-namespace tsd-is-external">
			<a href="node_modules__types_frida_gum.weakref.html#bind" class="tsd-kind-icon">bind</a>
		</li>
		<li class=" tsd-kind-function tsd-parent-kind-namespace tsd-is-external">
			<a href="node_modules__types_frida_gum.weakref.html#unbind" class="tsd-kind-icon">unbind</a>
		</li>
	</ul>
</nav>
	...
	<div class="content-wrap">
		<section class="tsd-panel tsd-comment">
			<div class="tsd-comment tsd-typography">
				<div class="lead">
					<p>Monitors the lifetime of a heap-allocated JavaScript value.</p>
				</div>
				...
				<div class="tsd-index-content">
					<section class="tsd-index-section tsd-is-external">
						...
						<ul class="tsd-index-list">
							<li class="tsd-kind-function tsd-parent-kind-namespace tsd-is-external"><a href="node_modules__types_frida_gum.weakref.html#bind" class="tsd-kind-icon">bind</a></li>
							<li class="tsd-kind-function tsd-parent-kind-namespace tsd-is-external"><a href="node_modules__types_frida_gum.weakref.html#unbind" class="tsd-kind-icon">unbind</a></li>
						</ul>
					</section>
				</div>
			</section>
		...
		<section class="tsd-panel-group tsd-member-group tsd-is-external">
			...
			<section class="tsd-panel tsd-member tsd-kind-function tsd-parent-kind-namespace tsd-is-external">
				...
				<ul class="tsd-signatures tsd-kind-function tsd-parent-kind-namespace tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">bind<span class="tsd-signature-symbol">(</span>target<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">any</span>, callback<span class="tsd-signature-symbol">: </span><a href="node_modules__types_frida_gum.html#weakrefcallback" class="tsd-signature-type" data-tsd-kind="Type alias">WeakRefCallback</a><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><a href="node_modules__types_frida_gum.html#weakrefid" class="tsd-signature-type" data-tsd-kind="Type alias">WeakRefId</a></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						...
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Starts monitoring the lifetime of <code>target</code>. Calls <code>callback</code> as soon as
						...
						<ul class="tsd-parameters">
							<li>
								...
								<div class="tsd-comment tsd-typography">
									<p>Heap-allocated JavaScript value to monitor lifetime of.</p>
								</div>
							</li>
							<li>
								<h5>callback: <a href="node_modules__types_frida_gum.html#weakrefcallback" class="tsd-signature-type" data-tsd-kind="Type alias">WeakRefCallback</a></h5>
								<div class="tsd-comment tsd-typography">
									<p>Function to call when <code>target</code> gets GCed.</p>
								</div>
							</li>
						</ul>
						<h4 class="tsd-returns-title">Returns <a href="node_modules__types_frida_gum.html#weakrefid" class="tsd-signature-type" data-tsd-kind="Type alias">WeakRefId</a></h4>
					</li>
				</ul>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-function tsd-parent-kind-namespace tsd-is-external">
				...
				<h3>unbind</h3>
				<ul class="tsd-signatures tsd-kind-function tsd-parent-kind-namespace tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">unbind<span class="tsd-signature-symbol">(</span>id<span class="tsd-signature-symbol">: </span><a href="node_modules__types_frida_gum.html#weakrefid" class="tsd-signature-type" data-tsd-kind="Type alias">WeakRefId</a><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">void</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
						...
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Stops monitoring the value passed to <code>WeakRef.bind()</code> and calls the
						...
						<ul class="tsd-parameters">
							<li>
								<h5>id: <a href="node_modules__types_frida_gum.html#weakrefid" class="tsd-signature-type" data-tsd-kind="Type alias">WeakRefId</a></h5>
								<div class="tsd-comment tsd-typography">
									<p>ID returned by a previous call to <code>WeakRef.bind()</code>.</p>
								</div>
							</li>
						</ul>
