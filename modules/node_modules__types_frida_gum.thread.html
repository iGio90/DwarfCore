...
<nav class="tsd-navigation secondary">
	<ul>
		<li class=" tsd-kind-function tsd-parent-kind-namespace tsd-is-external">
			<a href="node_modules__types_frida_gum.thread.html#backtrace" class="tsd-kind-icon">backtrace</a>
		</li>
		<li class=" tsd-kind-function tsd-parent-kind-namespace tsd-is-external">
			<a href="node_modules__types_frida_gum.thread.html#sleep" class="tsd-kind-icon">sleep</a>
		</li>
	</ul>
</nav>
	...
	<div class="content-wrap">
				...
				<div class="tsd-index-content">
					<section class="tsd-index-section tsd-is-external">
						...
						<ul class="tsd-index-list">
							<li class="tsd-kind-function tsd-parent-kind-namespace tsd-is-external"><a href="node_modules__types_frida_gum.thread.html#backtrace" class="tsd-kind-icon">backtrace</a></li>
							<li class="tsd-kind-function tsd-parent-kind-namespace tsd-is-external"><a href="node_modules__types_frida_gum.thread.html#sleep" class="tsd-kind-icon">sleep</a></li>
						</ul>
					</section>
				</div>
			</section>
		...
		<section class="tsd-panel-group tsd-member-group tsd-is-external">
			...
			<section class="tsd-panel tsd-member tsd-kind-function tsd-parent-kind-namespace tsd-is-external">
				<a name="backtrace" class="tsd-anchor"></a>
				<h3>backtrace</h3>
				<ul class="tsd-signatures tsd-kind-function tsd-parent-kind-namespace tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">backtrace<span class="tsd-signature-symbol">(</span>context<span class="tsd-signature-symbol">?: </span><a href="node_modules__types_frida_gum.html#cpucontext" class="tsd-signature-type" data-tsd-kind="Type alias">CpuContext</a>, backtracer<span class="tsd-signature-symbol">?: </span><a href="../classes/node_modules__types_frida_gum.backtracer.html" class="tsd-signature-type" data-tsd-kind="Class">Backtracer</a><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><a href="../classes/node_modules__types_frida_gum.nativepointer.html" class="tsd-signature-type" data-tsd-kind="Class">NativePointer</a><span class="tsd-signature-symbol">[]</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						...
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Generates a backtrace for the given thread&#39;s <code>context</code>.</p>
							</div>
						...
						<ul class="tsd-parameters">
							<li>
								<h5><span class="tsd-flag ts-flagOptional">Optional</span> context: <a href="node_modules__types_frida_gum.html#cpucontext" class="tsd-signature-type" data-tsd-kind="Type alias">CpuContext</a></h5>
								<div class="tsd-comment tsd-typography">
									<p>CPU context to use for generating the backtrace.</p>
								</div>
							</li>
							<li>
								<h5><span class="tsd-flag ts-flagOptional">Optional</span> backtracer: <a href="../classes/node_modules__types_frida_gum.backtracer.html" class="tsd-signature-type" data-tsd-kind="Class">Backtracer</a></h5>
								<div class="tsd-comment tsd-typography">
									<p>The kind of backtracer to use. Must be either
										<code>Backtracer.FUZZY</code> or <code>Backtracer.ACCURATE</code>,
									where the latter is the default if not specified.</p>
								</div>
							</li>
						</ul>
						<h4 class="tsd-returns-title">Returns <a href="../classes/node_modules__types_frida_gum.nativepointer.html" class="tsd-signature-type" data-tsd-kind="Class">NativePointer</a><span class="tsd-signature-symbol">[]</span></h4>
					</li>
				</ul>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-function tsd-parent-kind-namespace tsd-is-external">
				...
				<h3>sleep</h3>
				<ul class="tsd-signatures tsd-kind-function tsd-parent-kind-namespace tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">sleep<span class="tsd-signature-symbol">(</span>delay<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">number</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">void</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
						...
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Suspends execution of the current thread for <code>delay</code> seconds.</p>
							</div>
