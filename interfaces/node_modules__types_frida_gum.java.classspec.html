...
<nav class="tsd-navigation secondary">
	<ul>
		<li class="current tsd-kind-interface tsd-parent-kind-namespace tsd-is-external">
			<a href="node_modules__types_frida_gum.java.classspec.html" class="tsd-kind-icon">Class<wbr>Spec</a>
			<ul>
				<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-external">
					<a href="node_modules__types_frida_gum.java.classspec.html#fields" class="tsd-kind-icon">fields</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-external">
					<a href="node_modules__types_frida_gum.java.classspec.html#implements" class="tsd-kind-icon">implements</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-external">
					<a href="node_modules__types_frida_gum.java.classspec.html#methods" class="tsd-kind-icon">methods</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-external">
					<a href="node_modules__types_frida_gum.java.classspec.html#name" class="tsd-kind-icon">name</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-external">
					<a href="node_modules__types_frida_gum.java.classspec.html#superclass" class="tsd-kind-icon">super<wbr>Class</a>
				</li>
			</ul>
		</li>
	</ul>
				...
				<div class="tsd-index-content">
					<section class="tsd-index-section tsd-is-external">
						...
						<ul class="tsd-index-list">
							<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-external"><a href="node_modules__types_frida_gum.java.classspec.html#fields" class="tsd-kind-icon">fields</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-external"><a href="node_modules__types_frida_gum.java.classspec.html#implements" class="tsd-kind-icon">implements</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-external"><a href="node_modules__types_frida_gum.java.classspec.html#methods" class="tsd-kind-icon">methods</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-external"><a href="node_modules__types_frida_gum.java.classspec.html#name" class="tsd-kind-icon">name</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-external"><a href="node_modules__types_frida_gum.java.classspec.html#superclass" class="tsd-kind-icon">super<wbr>Class</a></li>
						</ul>
					</section>
				</div>
			</section>
		...
		<section class="tsd-panel-group tsd-member-group tsd-is-external">
			...
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface tsd-is-external">
				...
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>Name and type of each field to expose.</p>
					</div>
				</div>
			...
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface tsd-is-external">
				...
				<h3><span class="tsd-flag ts-flagOptional">Optional</span> implements</h3>
				<div class="tsd-signature tsd-kind-icon">implements<span class="tsd-signature-symbol">:</span> <a href="../modules/node_modules__types_frida_gum.java.html#wrapper" class="tsd-signature-type" data-tsd-kind="Type alias">Wrapper</a><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-symbol">{}</span><span class="tsd-signature-symbol">&gt;</span><span class="tsd-signature-symbol">[]</span></div>
				<aside class="tsd-sources">
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>Interfaces implemented by this class.</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface tsd-is-external">
				...
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>Methods to implement. Use the special name <code>$init</code> to define one or more constructors.</p>
					</div>
				</div>
				<div class="tsd-type-declaration">
					<h4>Type declaration</h4>
					<ul class="tsd-parameters">
						<li class="tsd-parameter-index-signature">
							<h5><span class="tsd-signature-symbol">[</span>name: <span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">]: </span><a href="../modules/node_modules__types_frida_gum.java.html#methodimplementation" class="tsd-signature-type" data-tsd-kind="Type alias">MethodImplementation</a><span class="tsd-signature-symbol"> | </span><a href="node_modules__types_frida_gum.java.methodspec.html" class="tsd-signature-type" data-tsd-kind="Interface">MethodSpec</a><span class="tsd-signature-symbol"> | </span><a href="node_modules__types_frida_gum.java.methodspec.html" class="tsd-signature-type" data-tsd-kind="Interface">MethodSpec</a><span class="tsd-signature-symbol">[]</span></h5>
						</li>
					</ul>
				</div>
			</section>
			...
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface tsd-is-external">
				...
				<h3><span class="tsd-flag ts-flagOptional">Optional</span> super<wbr>Class</h3>
				<div class="tsd-signature tsd-kind-icon">super<wbr>Class<span class="tsd-signature-symbol">:</span> <a href="../modules/node_modules__types_frida_gum.java.html#wrapper" class="tsd-signature-type" data-tsd-kind="Type alias">Wrapper</a><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-symbol">{}</span><span class="tsd-signature-symbol">&gt;</span></div>
				<aside class="tsd-sources">
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>Super-class. Omit to inherit from <code>java.lang.Object</code>.</p>
					</div>
				</div>
			</section>
		</section>
