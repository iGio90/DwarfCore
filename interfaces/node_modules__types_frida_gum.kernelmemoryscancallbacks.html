...
<head>
	...
	<title>KernelMemoryScanCallbacks | DwarfCore</title>
...
<nav class="tsd-navigation secondary">
	<ul>
		<li class="current tsd-kind-interface tsd-parent-kind-module tsd-is-external">
			<a href="node_modules__types_frida_gum.kernelmemoryscancallbacks.html" class="tsd-kind-icon">Kernel<wbr>Memory<wbr>Scan<wbr>Callbacks</a>
			<ul>
				<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-external">
					<a href="node_modules__types_frida_gum.kernelmemoryscancallbacks.html#oncomplete" class="tsd-kind-icon">on<wbr>Complete</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-external">
					<a href="node_modules__types_frida_gum.kernelmemoryscancallbacks.html#onerror" class="tsd-kind-icon">on<wbr>Error</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-external">
					<a href="node_modules__types_frida_gum.kernelmemoryscancallbacks.html#onmatch" class="tsd-kind-icon">on<wbr>Match</a>
				</li>
			</ul>
		</li>
	</ul>
	...
	<div class="content-wrap">
		<section class="tsd-panel tsd-hierarchy">
			...
			<ul class="tsd-hierarchy">
				<li>
					<span class="target">KernelMemoryScanCallbacks</span>
				</li>
			</ul>
		</section>
				...
				<div class="tsd-index-content">
					<section class="tsd-index-section tsd-is-external">
						...
						<ul class="tsd-index-list">
							<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-external"><a href="node_modules__types_frida_gum.kernelmemoryscancallbacks.html#oncomplete" class="tsd-kind-icon">on<wbr>Complete</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-external"><a href="node_modules__types_frida_gum.kernelmemoryscancallbacks.html#onerror" class="tsd-kind-icon">on<wbr>Error</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-external"><a href="node_modules__types_frida_gum.kernelmemoryscancallbacks.html#onmatch" class="tsd-kind-icon">on<wbr>Match</a></li>
						</ul>
					</section>
				</div>
			</section>
		...
		<section class="tsd-panel-group tsd-member-group tsd-is-external">
			...
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface tsd-is-external">
				...
				<div class="tsd-signature tsd-kind-icon">on<wbr>Complete<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-symbol">(</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol"> =&gt; </span><span class="tsd-signature-type">void</span></div>
				<aside class="tsd-sources">
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>Called when the memory range has been fully scanned.</p>
					</div>
				</div>
			...
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface tsd-is-external">
				...
				<div class="tsd-signature tsd-kind-icon">on<wbr>Error<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-symbol">(</span>reason<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol"> =&gt; </span><span class="tsd-signature-type">void</span></div>
				<aside class="tsd-sources">
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>Called when there was a memory access error while scanning.</p>
					</div>
					<dl class="tsd-comment-tags">
						<dt>param</dt>
						<dd><p>Why the memory access failed.</p>
						</dd>
					</dl>
				</div>
				<div class="tsd-type-declaration">
			...
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface tsd-is-external">
				<a name="onmatch" class="tsd-anchor"></a>
				<h3>on<wbr>Match</h3>
				<div class="tsd-signature tsd-kind-icon">on<wbr>Match<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-symbol">(</span>address<span class="tsd-signature-symbol">: </span><a href="../classes/node_modules__types_frida_gum.uint64.html" class="tsd-signature-type" data-tsd-kind="Class">UInt64</a>, size<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">number</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol"> =&gt; </span><span class="tsd-signature-type">void</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">&quot;stop&quot;</span></div>
				<aside class="tsd-sources">
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>Called with each occurence that was found.</p>
					</div>
					<dl class="tsd-comment-tags">
						<dt>param</dt>
						<dd><p>Memory address where a match was found.</p>
						</dd>
						<dt>param</dt>
						<dd><p>Size of this match.</p>
						</dd>
					</dl>
				</div>
				<div class="tsd-type-declaration">
					...
					<ul class="tsd-parameters">
						<li class="tsd-parameter-signature">
							<ul class="tsd-signatures tsd-kind-type-literal tsd-parent-kind-interface tsd-is-external">
								<li class="tsd-signature tsd-kind-icon"><span class="tsd-signature-symbol">(</span>address<span class="tsd-signature-symbol">: </span><a href="../classes/node_modules__types_frida_gum.uint64.html" class="tsd-signature-type" data-tsd-kind="Class">UInt64</a>, size<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">number</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">void</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">&quot;stop&quot;</span></li>
							</ul>
							<ul class="tsd-descriptions">
								<li class="tsd-description">
									<h4 class="tsd-parameters-title">Parameters</h4>
									...
									<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">void</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">&quot;stop&quot;</span></h4>
								</li>
							</ul>
						</li>
					</ul>
