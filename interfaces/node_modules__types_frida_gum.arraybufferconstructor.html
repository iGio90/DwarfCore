...
<head>
	...
	<title>ArrayBufferConstructor | DwarfCore</title>
...
<nav class="tsd-navigation secondary">
	<ul>
		<li class="current tsd-kind-interface tsd-parent-kind-module tsd-is-external">
			<a href="node_modules__types_frida_gum.arraybufferconstructor.html" class="tsd-kind-icon">Array<wbr>Buffer<wbr>Constructor</a>
			<ul>
				<li class=" tsd-kind-constructor tsd-parent-kind-interface tsd-is-external">
					<a href="node_modules__types_frida_gum.arraybufferconstructor.html#constructor" class="tsd-kind-icon">constructor</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-external">
					<a href="node_modules__types_frida_gum.arraybufferconstructor.html#_symbol_species_" class="tsd-kind-icon">[<wbr>Symbol.species]</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface tsd-is-external">
					<a href="node_modules__types_frida_gum.arraybufferconstructor.html#prototype" class="tsd-kind-icon">prototype</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-interface tsd-is-external">
					<a href="node_modules__types_frida_gum.arraybufferconstructor.html#isview" class="tsd-kind-icon">is<wbr>View</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-interface tsd-is-external">
					<a href="node_modules__types_frida_gum.arraybufferconstructor.html#wrap" class="tsd-kind-icon">wrap</a>
				</li>
			</ul>
		</li>
	</ul>
	...
	<div class="content-wrap">
				...
				<div class="tsd-index-content">
					<section class="tsd-index-section tsd-is-external">
						...
						<ul class="tsd-index-list">
							<li class="tsd-kind-constructor tsd-parent-kind-interface tsd-is-external"><a href="node_modules__types_frida_gum.arraybufferconstructor.html#constructor" class="tsd-kind-icon">constructor</a></li>
						</ul>
					</section>
					<section class="tsd-index-section tsd-is-external">
						<h3>Properties</h3>
						<ul class="tsd-index-list">
							<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-external"><a href="node_modules__types_frida_gum.arraybufferconstructor.html#_symbol_species_" class="tsd-kind-icon">[<wbr>Symbol.species]</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface tsd-is-external"><a href="node_modules__types_frida_gum.arraybufferconstructor.html#prototype" class="tsd-kind-icon">prototype</a></li>
						</ul>
					</section>
					<section class="tsd-index-section tsd-is-external">
						<h3>Methods</h3>
						<ul class="tsd-index-list">
							<li class="tsd-kind-method tsd-parent-kind-interface tsd-is-external"><a href="node_modules__types_frida_gum.arraybufferconstructor.html#isview" class="tsd-kind-icon">is<wbr>View</a></li>
							<li class="tsd-kind-method tsd-parent-kind-interface tsd-is-external"><a href="node_modules__types_frida_gum.arraybufferconstructor.html#wrap" class="tsd-kind-icon">wrap</a></li>
						</ul>
					</section>
				</div>
			</section>
		...
		<section class="tsd-panel-group tsd-member-group tsd-is-external">
			...
			<section class="tsd-panel tsd-member tsd-kind-constructor tsd-parent-kind-interface tsd-is-external">
				...
				<ul class="tsd-signatures tsd-kind-constructor tsd-parent-kind-interface tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">new <wbr>Array<wbr>Buffer<wbr>Constructor<span class="tsd-signature-symbol">(</span>byteLength<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">number</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><a href="../modules/node_modules__types_frida_gum.html#arraybuffer-1" class="tsd-signature-type" data-tsd-kind="Variable">ArrayBuffer</a></li>
				</ul>
		...
		<section class="tsd-panel-group tsd-member-group tsd-is-external">
			...
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface tsd-is-external">
				...
				<div class="tsd-signature tsd-kind-icon">[<wbr>Symbol.species]<span class="tsd-signature-symbol">:</span> <a href="node_modules__types_frida_gum.arraybufferconstructor.html" class="tsd-signature-type" data-tsd-kind="Interface">ArrayBufferConstructor</a></div>
				<aside class="tsd-sources">
				</aside>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface tsd-is-external">
				...
				<div class="tsd-signature tsd-kind-icon">prototype<span class="tsd-signature-symbol">:</span> <a href="../modules/node_modules__types_frida_gum.html#arraybuffer-1" class="tsd-signature-type" data-tsd-kind="Variable">ArrayBuffer</a></div>
				<aside class="tsd-sources">
				</aside>
			</section>
		</section>
		<section class="tsd-panel-group tsd-member-group tsd-is-external">
			...
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-interface tsd-is-external">
				...
				<h3>wrap</h3>
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-interface tsd-is-external">
					<li class="tsd-signature tsd-kind-icon">wrap<span class="tsd-signature-symbol">(</span>address<span class="tsd-signature-symbol">: </span><a href="../modules/node_modules__types_frida_gum.html#nativepointervalue" class="tsd-signature-type" data-tsd-kind="Type alias">NativePointerValue</a>, size<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">number</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><a href="../modules/node_modules__types_frida_gum.html#arraybuffer-1" class="tsd-signature-type" data-tsd-kind="Variable">ArrayBuffer</a></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
						...
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Creates an ArrayBuffer backed by an existing memory region. Unlike
						...
						<ul class="tsd-parameters">
							<li>
								...
								<div class="tsd-comment tsd-typography">
									<p>Base address of the region. Passing <code>NULL</code> will result
							...
							<li>
								...
								<div class="tsd-comment tsd-typography">
									<p>Size of the region. Passing <code>0</code> will result in an empty
									buffer.</p>
								</div>
							</li>
						</ul>
